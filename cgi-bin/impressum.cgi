...
print('<a href="https://' + os.environ["HTTP_HOST"] + '/cgi-bin/splitline.cgi">SplitLine</a>')
print('<a class="active" href="https://' + os.environ["HTTP_HOST"] + '/cgi-bin/impressum.cgi">Impressum</a>')
print('</div>')
